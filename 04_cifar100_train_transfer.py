...
# Train setting
parser.add_argument("--model_name", help="ResNeXt101, ResNet101, ResNet18, DenseNet121, DenseNet169, MobileNetv2",
                    default="MobileNetv2")
...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='MobileNetv2_cifar100_32_lr01')
# reproducibility
...
#testset_attack, _ = torch.utils.data.random_split(testset_SVHN, [2000, len(testset_SVHN)-2000])
...
trainset_attack = torchvision.datasets.ImageFolder("/data/gehan/Datasets/butterflies_moths/train", transform_train)
...
if args.model_name == 'ResNet18':
    ...
    target = ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    ...
    from backbones.ResNeXt import ResNeXt, ResNeXt101_32x4d
    target = ResNeXt(num_blocks=[3, 4, 23, 3], cardinality=32, bottleneck_width=4, num_classes=num_classes)
...
#ResNet101_32_SVHN{0: 14, 1: 65, 2: 18, 3: 45, 4: 48, 5: 70, 6: 9, 7: 26, 8: 24, 9: 57, 10: 0, 11: 1, 12: 2, 13: 3, 14: 4, 15: 5, 16: 6, 17: 7, 18: 8, 19: 10, 20: 11, 21: 12, 22: 13, 23: 15, 24: 16, 25: 17, 26: 19, 27: 20, 28: 21, 29: 22, 30: 23, 31: 25, 32: 27, 33: 28, 34: 29, 35: 30, 36: 31, 37: 32, 38: 33, 39: 34, 40: 35, 41: 36, 42: 37, 43: 38, 44: 39, 45: 40, 46: 41, 47: 42, 48: 43, 49: 44, 50: 46, 51: 47, 52: 49, 53: 50, 54: 51, 55: 52, 56: 53, 57: 54, 58: 55, 59: 56, 60: 58, 61: 59, 62: 60, 63: 61, 64: 62, 65: 63, 66: 64, 67: 66, 68: 67, 69: 68, 70: 69}
if args.remap:
...
for ep in range(6):
    ...
    if ep == 0:
        ...
        target_pruned_ft6 = copy.deepcopy(target_pruned)
...
if args.remap:
    ...
    remap = '_noremap'
model_list = [target, target_pruned_ft1, target_pruned_ft6]
alpha=0
enc_num_residual_blocks=0
enc_num_updownsampling=2
transfer_set = 'Enc_SVHN_prune_ft1-5_all_Chameleon%d_Enc%d%d-32'%(alpha, enc_num_residual_blocks, enc_num_updownsampling)
