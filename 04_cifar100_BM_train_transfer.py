...
for inputs, labels in trainset_attack_loader:
    a = 1
for inputs, labels in testset_attack_loader:
    a = 1
...
transfer_set = 'Enc_BM_prune_ft1-6_all_Chameleon%d_Enc%d%d-64'%(alpha, enc_num_residual_blocks, enc_num_updownsampling)
Enc, Enc_acc = train_transfer_shadow_Chameleon(model_list, trainset_attack_loader, testset_attack_loader, epochs=75,
                                               lr=0.0001,
