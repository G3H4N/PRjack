...
# Train setting
parser.add_argument("--model_name", help="ResNeXt50, ResNet18, DenseNet121, MobileNetv2, VGG19, EfficientNet, ShuffleNetV2, DarkNet53, CSPDarknet53",
                    default="DenseNet121")
...
trainset = torch.utils.data.Subset(Caltech101_train, train_indices)
testset = torch.utils.data.Subset(Caltech101_test, test_indices)
...
if args.model_name == 'VGG19':
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes)#ResNet50()
