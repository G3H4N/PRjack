...
parser.add_argument('--pruning-algo', type=str, default='fpgm',
...
transfer_set = 'Enc_GTSRB_prune_ft1-6_all_Chameleon%d_Enc%d%d'%(alpha, enc_num_residual_blocks, enc_num_updownsampling)
...
for set_pruner in ['slim', 'apoz', 'mean_activation', 'taylorfo', 'agp', 'lottery', 'AutoCompress', 'AMC']:
